...
def is_bad_id(soup):
    ...
    if 'is no longer in the database' in text:
        return True
    else:
        False
...
def get_brewer_info(brewer_url):
    ...
    if is_bad_id(soup):
        brewer_info['error'] = 'No longer in the database'
        return brewer_info
...
if __name__ == '__main__':
    ...
    print 'Total brewers', len(brewer_urls)
